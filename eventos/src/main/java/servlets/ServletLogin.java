...
import eventos.modelo.Usuario;

/**
 * Servlet implementation class ServletLogin
 */

// Esta anotacion podria ser sustituida e incluirlo en el web.xml 
...
public class ServletLogin extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// Comprueba si existe una cookie "aadd" para ver si el usuario esta logeado
		...
		if (cookies != null) {
		    ...
		    if (cookieAADD != null) {
		        ...
		        out.println("Identificación correcta utilizando cookie");
		        return;
		    }
		    
		    */
		    
		    // Delegar en servlet cookie
		...
		// Esto hace que cuando buscamos ServletLogin aparezca en el navegador el login.html
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    // Primera vez que se intenta logear
	    if (numFallos == null) {
	        numFallos = 0;
